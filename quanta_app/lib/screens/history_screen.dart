...
class _HistoryScreenState extends State<HistoryScreen> {
  ...
  void _cleanupOldHistory() {
    ...
    if (list.length > 20) {
      // Keep the newest 20 — HistoryStore.add inserts at index 0, so the
      // first 20 entries of the current list are the most recent.
      HistoryStore.setHistory(list.sublist(0, 20));
    }
  }
