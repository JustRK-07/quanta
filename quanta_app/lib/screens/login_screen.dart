      ...
      body: Stack(
        children: [
                ...
                return Container(
                  decoration: BoxDecoration(
                    gradient: LinearGradient(
                      colors: [
                        Color.lerp(
                            QuantaColors.surface1,
                            QuantaColors.cyan.withValues(alpha: 0.45),
                            _controller.value)!,
                        Color.lerp(
                            QuantaColors.void0,
                            QuantaColors.surface1,
          ...
          _BlurOrb(
            ...
            left: -40,
            size: 220,
            color: QuantaColors.cyan.withValues(alpha: 0.25),
      ...
      child: Row(
        children: [
          Container(
            ...
            child: Icon(icon, color: QuantaColors.cyan, size: 18),
          ),
