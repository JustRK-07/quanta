...
import 'package:quanta_app/services/groq_service.dart'; // UPDATED
...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  Future<void> _sendFeedback() async {
    final Uri email = Uri(
      scheme: 'mailto',
      path: 'teamquanta@gmail.com',
      query: 'subject=QUANTA Feedback&body=Your feedback:',
    );
  ...
  Future<void> _rateApp() async {
    const url = "https://play.google.com/store/apps/details?id=com.quanta.app";
            ...
            return Padding(
              ...
              child: ListView(
                ...
                children: [
                  ...
                  Text(
                    "We are the creators of QUANTA — a tool that transforms STEM learning into an interactive visual experience.",
                    style: TextStyle(
                      fontSize: 15,
      ...
      body: ListView(
        ...
        children: [
          ...
          SwitchListTile(
            ...
            subtitle: const Text("Receive updates from QUANTA"),
          ...
          ListTile(
            ...
            subtitle: const Text("Meet the team behind QUANTA"),
          ...
          ListTile(
            ...
            onTap: () => _openInfoSheet(
              ...
              title: "Send Feedback",
              message:
                  "We value your feedback. Help us improve QUANTA by sharing your thoughts.",
          ...
          ListTile(
            ...
            onTap: () => _openInfoSheet(
              ...
              title: "Rate QUANTA",
              message:
                  "If you enjoy QUANTA, support us by leaving a rating on the Play Store.",
