...
class _SplashScreenState extends State<SplashScreen>
  ...
  void initState() {
    ...
    Future.delayed(const Duration(milliseconds: 3500), () {
      if (!mounted) return;
      // Auth disabled for offline / demo mode — go straight to home.
                ...
                return Container(
                  decoration: BoxDecoration(
                    gradient: LinearGradient(
                      colors: [
                        Color.lerp(QuantaColors.void0, QuantaColors.surface1, _fade.value)!,
                        Color.lerp(QuantaColors.surface1, QuantaColors.cyan.withValues(alpha: 0.35), _fade.value)!,
                        Color.lerp(QuantaColors.cyan.withValues(alpha: 0.35), QuantaColors.amber.withValues(alpha: 0.18), _fade.value)!,
                      ],
                          ...
                          return Transform.scale(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                boxShadow: [
                                  BoxShadow(
                                    color: QuantaColors.cyan.withValues(alpha: 0.5),
                                    blurRadius: 40,
                                    spreadRadius: 5,
                                  ),
                                ],
                      ...
                      builder: (context, child) {
                        return Opacity(
                          ...
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: [
                              _AnimatedText("Point", _mainController, 0.3),
                              const Padding(
                                padding: EdgeInsets.symmetric(horizontal: 8),
                                child: Icon(Icons.arrow_forward, color: QuantaColors.cyan, size: 16),
                              ),
                              _AnimatedText("Visualise", _mainController, 0.45),
                              const Padding(
                                padding: EdgeInsets.symmetric(horizontal: 8),
                                child: Icon(Icons.arrow_forward, color: QuantaColors.cyan, size: 16),
                              ),
                              _AnimatedText("Master", _mainController, 0.6),
                            ],
                          ),
                        );
                      },
