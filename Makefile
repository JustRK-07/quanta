...
lint-flutter: ## Lint Flutter (analyze + format check)
	cd quanta_app && flutter analyze --no-fatal-infos
	cd quanta_app && dart format --set-exit-if-changed .
